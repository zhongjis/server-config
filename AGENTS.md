...
This project is indexed by GitNexus as **server-config** (490 symbols, 478 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/server-config/context` | Codebase overview, check index freshness |
| `gitnexus://repo/server-config/clusters` | All functional areas |
| `gitnexus://repo/server-config/processes` | All execution flows |
| `gitnexus://repo/server-config/process/{name}` | Step-by-step execution trace |
